...
namespace AirlineServices.Controllers
{
    public class PassengerController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "id,givenName,familyName,phoneNumber,address,country,birthdate")] Passenger passenger)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "id,givenName,familyName,phoneNumber,address,country,birthdate")] Passenger passenger)
        {
            if (ModelState.IsValid)
            {
